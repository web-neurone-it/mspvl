...
const AdminUpdateCategory: React.FC<AdminUpdateCategoryProps> = ({
	isOpen,
	onClose,
	inputValue,
	categoryImage,
	...
	const handleSaveChanges = () => {
		//@ts-ignore
		onUpdateCategory(id, inputValueInternal, categoryImage);
		console.log('товары - ', id, inputValueInternal, categoryImage);
		onClose();
	};
